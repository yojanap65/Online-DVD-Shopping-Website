...
public class DBHelper implements java.io.Serializable {
    private static String connectionURL = "jdbc:mysql://opatija:3306/jadrn040?user=jadrn040&password=paint";               
	...
	public static int getValue(String query, String value){
		  String answer = "";
      int result = 0;
	try {
	...
	while(resultSet.next())
		...
		public static int getValue1(String query, String value){
		  String answer = "";
		int result = -1;
	try {
	Class.forName("com.mysql.jdbc.Driver").newInstance();
	...
	while(resultSet.next())
		result = resultSet.getInt(value); 
		//System.out.println(resultSet.getInt(value) + " " + query);
	}
